...
set.seed(1)
classifcador = randomForest(x = base_treinamento[-15], y = base_treinamento$income, ntree = 20) 

# Predict para a base de testes
previsoes = predict(classifcador, newdata = base_teste[-15])
