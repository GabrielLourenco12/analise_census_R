...
# O ZeroR é o número mínimo de acertos que um algoritmo deve ter
# é so pegar a quantidade do valor que mais se repete na classe
# e dividir pela quantidade de valores na base de teste
